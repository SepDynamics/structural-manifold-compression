...
Using 512~byte windows, a 384~byte stride, and a 9~byte payload per unique signature, the proposed encoder delivers \textbf{41--42$\times$ byte} and \textbf{85--90$\times$ token compression} on the full benchmarks while retaining \textbf{94.9--95.3\% token accuracy} and \textbf{$<5.1\%$ normalized edit distance}.
...
All corpora exceed 41$\times$ byte compression and 85--90$\times$ token compression while retaining 94.9--95.3\% token accuracy and $<5.1\%$ normalized edit distance.
Hazard verification remains strict: Fox EN attains 91.21\% precision with only 0.087\% false positives, Fox CN reaches 97.19\% precision at 0.029\% FPR, and even the diverse OmniDoc corpus keeps precision above 80\% with a 0.017\% false-positive rate.
...
\begin{table}[h]
    ...
    \begin{tabular}{lrrrrrr}
        ...
        \midrule
        Fox EN (112)  & 42.03 & 85.48 & 95.35\% & 4.38\% & 91.21\% & 0.087\% \\
        Fox CN (100)  & 42.01 & 88.08 & 94.94\% & 4.96\% & 97.19\% & 0.029\% \\
        OmniDoc (1\,349) & 41.59 & 89.49 & 94.90\% & 5.06\% & 80.85\% & 0.017\% \\
        \bottomrule
    \end{tabular}
\end{table}
